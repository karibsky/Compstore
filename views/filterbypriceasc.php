...
$query = $connect->query("SELECT * FROM products ORDER by price ASC");
...
<body>
	...
	<div class="filters-content">
		<div class="filter-by-price"> 
			<span class="filter-text" style="color:#FF9900">По возрастанию цены<i class="fa fa-arrow-up"></i></span>
		</div>
